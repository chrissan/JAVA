public class tarea1 {
	...
	public tarea1(String direccion, float dinero)
	{
		...
		empleado e1 = new empleado("1", 1500);
		empleado e2 = new empleado("2", 1500);
		empleado e3 = new empleado("3", 1500);
		empleado e4 = new empleado("4", 1500);
		empleado e5 = new empleado("5", 1500);
